...
epicsEnvSet("PY_OBJECT", "CRL8ID")
epicsEnvSet("SYS_ID", "CRL8ID")
epicsEnvSet("SUBS_FILE", "substitutions/pyDevCRL_stacks_double_8ID.substitutions")
epicsEnvSet("TOML_FILE", "toml/crl_setup_double_8ID.toml")
