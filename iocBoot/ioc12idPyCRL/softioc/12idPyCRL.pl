...
BEGIN
{
	...
	#! $ENV{IOC_STARTUP_DIR}="/home/username/epics/ioc/synApps/100idPy/iocBoot/ioc12idPyCRL";
	...
	#! $ENV{IOC_COMMAND_DIR}="/home/username/epics/ioc/synApps/100idPy/iocBoot/ioc12idPyCRL/softioc/commands";
	...
	$ENV{PYDEV_STARTUP}="$ENV{IOC_STARTUP_DIR}/12idPyCRL_startup_env";
