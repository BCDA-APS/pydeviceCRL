...
dbLoadTemplate("substitutions/pyDevCRL_stacks_double.substitutions","P=$(PREFIX),SYSID=$(SYS_ID)")
pydev("stack_subFile = 'substitutions/pyDevCRL_stacks_double.substitutions'")
...
pydev("$(PY_OBJECT) = focusingSystem(crl_setup = 'crl_setup_double.toml')")
